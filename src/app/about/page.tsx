      ...
      <div className="space-y-6">
        ...
        <section className="space-y-3">
          ...
          <div className="rounded-lg border divide-y">
            <InfoRow label="版本" value={`v${buildInfo.version}`} href={`https://github.com/yoea/vibe_blog_next/releases/tag/v${buildInfo.version}`} />
...
function InfoRow({ label, value, mono, href }: { label: string; value: string; mono?: boolean; href?: string }) {
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2.5 text-sm">
      ...
      {href ? (
        <a href={href} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:underline transition-colors">
